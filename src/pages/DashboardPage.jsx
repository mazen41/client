...
//   return (
//     <div className="dashboard-main" style={{ backgroundColor: 'white' }}>
...
//           {[{ label: 'awaitingBalance', amount: cardData.awaitingBalance, icon: 'money-bill-wave' },
//             { label: 'awaitingTransfer', amount: cardData.awaitingTransfer, icon: 'exchange-alt' },
//             { label: 'disputeAmount', amount: cardData.disputeAmount, icon: 'exclamation-triangle' }]
//             .map((card, index) => (
//               <div className="card" key={index} style={{ flex: '1', backgroundColor: '#fff' }}>
//                 <div className="card-content">
//                   <div className="media">
//                     <div className="media-content">
//                       <p className="title is-4" style={{colro: "#000"}}>{t(`dashboard.${card.label}`)}</p>
//                       <p className="subtitle is-6">{card.amount.toLocaleString()} SAR</p>
//                     </div>
...
//           <div className="card-content">
//             <p className="title is-5">{t('dashboard.lastPayments')}</p>
...
//                       <td>
//                         <span className={`tag ${payment.status === 'completed' ? 'is-success' : 
//                           payment.status === 'pending' ? 'is-warning' : 'is-danger'}`}>
//                           {t(`dashboard.statuses.${payment.status}`)}
//                         </span>
//                       </td>
//                     </tr>
//                   ))}
...
//           {[{ chart: <Line data={grossNetData} />, label: 'grossNetChart' },
//             { chart: <Bar data={successFailedData} />, label: 'successFailedChart' },
//             { chart: <Pie data={financialSummaryData} />, label: 'financialSummary' },
//             { chart: <Pie data={paymentMethodsData} />, label: 'paymentMethods' }]
//             .map((chartItem, index) => (
//               <div className="card" key={index} style={{ flex: '1', backgroundColor: '#fff' }}>
//                 <div className="card-content">
//                   <p className="title is-5">{t(`dashboard.${chartItem.label}`)}</p>
//                   {chartItem.chart}
//                 </div>
//               </div>
//             ))}
